...
<head>
    ...
    <title>Stockify - Sistem Kasir & Inventory Angkringan</title>
...
<body>
    ...
    <section class="hero text-white py-20">
        <div class="container mx-auto text-center">
            <h1 class="text-4xl font-bold mb-4">Kelola Angkringan Anda dengan Mudah</h1>
            <p class="text-xl mb-8 max-w-2xl mx-auto">
                Stockify solusi anda mengatur penjualan, stok, dan laporan usaha angkringan secara modern.
            </p>
            <div class="space-x-4">
